...
Config tags apply editor settings without running the model. They may be inline or multiline and are triggered when the caret is inside the tag or immediately after it and the user generates.
