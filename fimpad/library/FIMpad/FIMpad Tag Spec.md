...
Config tags apply editor settings. They may be inline or multiline and are triggered when the caret is inside or immediately after a config tag and the user presses Ctrl+Shift+C (or uses the menu entry at AI -> Apply Config Tag).
